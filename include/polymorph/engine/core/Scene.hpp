...
/////////////////////////////// METHODS /////////////////////////////////
        public:
            /**
             * @details Loops trough entities and calls their update method
             */
            void update();
            ...
            /**
             * @details Loops trough entities and calls their awake method
             */
            void awake();

            /**
             * @details Loops trough entities and calls their build method
             */
            void build();


            /**
             * @details Loops trough entities and calls their onSceneLoaded method
             */
            void onSceneLoaded();


            /**
             * @details Loops trough entities and calls their onSceneUnloaded method
             */
            void onSceneUnloaded();

            /**
             * @details Saves the scene to the given file
             * @param saveAllEntitiesFirst if true, all current entities will be saved to the scene file
             * @param path the file to save the scene to
             */
            void save(bool saveAllEntitiesFirst = false, std::string path = "");
